      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
        ...
        <div className="mb-8">
          <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6 gap-4">
            <Link
              href="/products"
              className={`p-4 rounded-xl font-medium transition-all flex flex-col items-center gap-3 ${
                !categorySlug
                  ? "bg-indigo-600 text-white shadow-lg"
                  : "bg-white text-indigo-600 border-2 border-indigo-600 hover:bg-indigo-50 hover:shadow-md"
              }`}
            >
              <Box size={40} strokeWidth={2.5} />
              <span className="text-sm text-center">All Products</span>
            </Link>
            {categories.map((cat) => {
